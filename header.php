											...
											echo '<li class="header-account dropdown default-dropdown">
															<div class="dropdown-toggle" role="button" data-toggle="dropdown" aria-expanded="true">
																<div class="header-btns-icon">
																	...
																	<div class="dropdownn ">
                                  <a href="#" class="dropdownn " data-toggle="modal" data-target="#myModal" > <strong class="text-uppercase whiter" >My Account <i class="fa fa-caret-down whiter"></i></strong></a>
                                </div>
	  													</div>
  													<ul class="custom-menu">
							...
							<div class="custom-menu " >
								<div class="cart-dropdown">
									...
									<div class="shopping-cart-btns">
										<button class="main-btn "id="remove" ><a href="#" >Clear cart
